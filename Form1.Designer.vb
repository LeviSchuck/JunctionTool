...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        'OpenFileDialog1
        '
        Me.OpenFileDialog1.FileName = "junction.exe"
        Me.OpenFileDialog1.Filter = "Junction Program|junction.exe"
        '
        'Button1
        '
        ...
        Me.Button1.Text = "Choose Existing"
